...
const packages = [
  {
    ...
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০১',
  },
  {
    id: 2,
    ...
    popular: true,
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০২',
  },
  {
    id: 3,
    ...
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০৩',
  },
  {
    id: 4,
    name: 'পরিবারিক ওমরাহ প্যাকেজ',
    duration: '২৫ দিন',
    price: '১,৮০,০০০',
    oldPrice: '২,১০,০০০',
    ...
    color: '#10B981',
    image: 'https://images.unsplash.com/photo-1564769625392-651b89c25c66?w=400&q=80',
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০৪',
  },
  {
    id: 5,
    name: 'বেসরকারি ওমরাহ প্যাকেজ',
    duration: '৩০ দিন',
    price: '২,৫০,০০০',
    oldPrice: '৩,০০,০০০',
    ...
    image: 'https://images.unsplash.com/photo-1591604129939-f1efa4d9f7fa?w=400&q=80',
    popular: true,
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০৫',
  },
  {
    id: 6,
    name: 'প্রিমিয়াম প্লাস ওমরাহ প্যাকেজ',
    duration: '৩৫ দিন',
    price: '৩,৫০,০০০',
    oldPrice: '৪,০০,০০০',
    ...
    color: '#7C3AED',
    image: 'https://images.unsplash.com/photo-1607619056574-7b8d3ee536b2?w=400&q=80',
    license: 'ওমরাহ লাইসেন্স: OB-২০২৫-০০৬',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest mb-4"
            ...
            <Star size={14} />
            <span>ওমরাহ প্যাকেজ</span>
          </div>
          <h1 className="text-3xl sm:text-5xl font-bold mb-3" style={{color: '#0B4D2E'}}>
            আপনার বাজেট অনুযায়ী <span className="bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-600 bg-clip-text text-transparent">সেরা ওমরাহ</span> বেছে নিন
          </h1>
          ...
          <p className="text-gray-600 mt-4 max-w-xl mx-auto text-sm sm:text-base">
            ইকোনমি থেকে আল্ট্রা প্রিমিয়াম — ৬টি ভিন্ন বাজেটের ওমরাহ প্যাকেজ। সকল প্যাকেজে সরকার অনুমোদিত সেবা ও স্বচ্ছতা নিশ্চিত।
          </p>
        </div>
